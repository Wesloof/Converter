...
inline System::Void Converterr::MyForm::button1_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    if (radioButton1->Checked == true)
    {
        ...
        change("[Col79]", "[Col83]", Convert::ToDouble(textBox6->Text));

        change("[Col80]", "[Col84]", Convert::ToDouble(textBox3->Text));

        change("[Col79]", "[Col85]", Convert::ToDouble(textBox7->Text));

        change("[Col80]", "[Col86]", Convert::ToDouble(textBox10->Text));

        change("[Col95]", "[Col99]", Convert::ToDouble(textBox5->Text));

        change("[Col96]", "[Col100]", Convert::ToDouble(textBox2->Text));

        change("[Col95]", "[Col101]", Convert::ToDouble(textBox8->Text));

        change("[Col96]", "[Col102]", Convert::ToDouble(textBox11->Text));
    ...
    if (radioButton2->Checked == true)
    {
        ...
        change("[Col78]", "[Col82]", Convert::ToDouble(textBox6->Text));
        change("[Col79]", "[Col83]", Convert::ToDouble(textBox3->Text));
        change("[Col78]", "[Col84]", Convert::ToDouble(textBox7->Text));
        change("[Col79]", "[Col85]", Convert::ToDouble(textBox10->Text));

        change("[Col94]", "[Col98]", Convert::ToDouble(textBox5->Text));

        change("[Col95]", "[Col99]", Convert::ToDouble(textBox2->Text));

        change("[Col94]", "[Col100]", Convert::ToDouble(textBox8->Text));

        change("[Col95]", "[Col101]", Convert::ToDouble(textBox11->Text));
